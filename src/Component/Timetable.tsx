  ...
  return (
    ...
    <h1 className="font-montserrat lg:text-[22px] sm:text-[14px] font-bold leading-6 ">
     ...
     Student Timetable
      ...
      <div className="bg-white w-[100%] pt-[14px] mt-3 px-4">
      <p className="text-[#4D515A]  lg:text-[14px] sm:text-[10px] leading-3 py-2">
   Your Class
    </p> 
    <Button className='bg-[#8B8E93]'>Class 9A</Button>
    <Table className="bg-white lg:text-[14px] sm:text-[12px] w-[90vw] mt-4 ">
  
  <TableHeader>
    <TableRow className="bg-[#FAF8FC] sm:text-[9px] lg:text-[14px]">
      <TableHead className='font-montserrat font-bold text-black'>DAYS</TableHead>
      <TableHead className='font-montserrat font-bold text-black'>8:00-9:00</TableHead>
      <TableHead className='font-montserrat font-bold text-black '>9:00-10:00</TableHead>
      <TableHead className='font-montserrat font-bold text-black w-[150px] '>10:00-11:00</TableHead>
      <TableHead className='font-montserrat font-bold text-black'>11:00-12:00</TableHead>
      <TableHead className='font-montserrat font-bold text-black '>12:00-01:00</TableHead>
      <TableHead className='font-montserrat font-bold text-black '>01:00-02:00</TableHead>
